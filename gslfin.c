...
void *threadThree(){
    ...
    int t,h;
	gsl_matrix * matrizXT = gsl_matrix_alloc(columnas, filas);
	gsl_matrix * matrizX = gsl_matrix_alloc(filas, columnas - intervalo2);
	gsl_matrix * matrizXTX = gsl_matrix_alloc(columnas, columnas - intervalo2);
	gsl_matrix_set_zero(matrizXTX);
	gsl_matrix_set_zero(matrizXT);
	gsl_matrix_set_zero(matrizX);
...
void *threadSix(){
    int i,j;
    int t,h;
	gsl_matrix * matrizINV = gsl_matrix_alloc(columnas, columnas - intervalo2);
	gsl_matrix * matrizX = gsl_matrix_alloc(filas, columnas);
	gsl_matrix * matrizAUX = gsl_matrix_alloc(filas, columnas - intervalo2);
	gsl_matrix_set_zero(matrizINV);
	gsl_matrix_set_zero(matrizX);
	gsl_matrix_set_zero(matrizAUX);
...
//	Se declaran dos matrices de 2x2
	...
	thread = calloc(6,sizeof(pthread_t));
